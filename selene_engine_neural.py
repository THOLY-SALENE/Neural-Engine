"""
SELENE ENGINE v11.1 — FINAL FULL STACK

Includes:
✔ True PPO (GAE, clipped objective, entropy, value loss)
✔ Vectorized environments
✔ Dataset export (.npz)
✔ Evaluation mode
✔ Clean toroidal manifold physics
✔ Beautiful 3D visualization

Run:
python selene_engine_final.py --mode train
python selene_engine_final.py --mode animate
"""
...
def train(epochs=200):
    ...
    for ep in range(epochs):
        ...
        for _ in range(4):
            ...
            value_loss=((val.squeeze()-returns)**2).mean()
    ...
    torch.save(policy.state_dict(),"selene_final.pt")
